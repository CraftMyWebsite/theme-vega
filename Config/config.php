...
<div id="tab-content-config">
    ...
    <div class="tab-content" id="tab1">
        <div class="grid-2">
            ...
            <div>
                <h6>Global</h6>
                <label class="toggle">
                    <p class="toggle-label">Switch light-dark</p>
                    <input type="checkbox" class="toggle-input" name="dark_light"
    ...
    <div class="tab-content" id="tab2">
        ...
        <h6>Réglages :</h6>
        <label class="toggle">
            <p class="toggle-label">Nombre de joueurs minecraft :</p>
            <input type="checkbox" class="toggle-input" name="hero_show_minecraft_player" <?= ThemeModel::getInstance()->fetchConfigValue('hero_show_minecraft_player') ? 'checked' : '' ?>>
            <div class="toggle-slider"></div>
        </label>
        <div class="flex items-center gap-2">
            <div class="col-lg-4">
                <input class="input text-center" type="text" id="hero_join_prefix"
            ...
            <div class="col-lg-4">
                <input class="input text-center" type="text" id="hero_join_suffix"
                       name="hero_join_suffix"
                       value="<?= ThemeModel::getInstance()->fetchConfigValue('hero_join_suffix') ?>">
            </div>
        </div>
        <label class="toggle">
            <p class="toggle-label">Icon footer :</p>
            <input type="checkbox" class="toggle-input" name="hero_show_footer_icon" <?= ThemeModel::getInstance()->fetchConfigValue('hero_show_footer_icon') ? 'checked' : '' ?>>
            <div class="toggle-slider"></div>
        </label>
        <h6>Images :</h6>
        ...
        <div class="grid-3">
            <div class="col card me-2">
                <div class="icon-picker" data-id="feature_img_1" data-name="feature_img_1" data-label="Icon :" data-placeholder="Sélectionner un icon" data-value="<?= ThemeModel::getInstance()->fetchConfigValue("feature_img_1") ?>"></div>
                ...
                <div class="form-group">
                    ...
                    <input class="input text-center" type="text" id="feature_description_1"
                           name="feature_description_1"
                           value="<?= ThemeModel::getInstance()->fetchConfigValue('feature_description_1') ?>">
                </div>
            </div>
            <div class="col card me-2">
                <div class="icon-picker" data-id="feature_img_2" data-name="feature_img_2" data-label="Icon :" data-placeholder="Sélectionner un icon" data-value="<?= ThemeModel::getInstance()->fetchConfigValue("feature_img_2") ?>"></div>
                <div class="form-group">
                    <label>Titre :</label>
                ...
                <div class="form-group">
                    <label>Description :</label>
                    <input class="input text-center" type="text" id="feature_description_2"
                           name="feature_description_2"
                           value="<?= ThemeModel::getInstance()->fetchConfigValue('feature_description_2') ?>">
                </div>
            </div>
            <div class="col card me-2">
                <div class="icon-picker" data-id="feature_img_3" data-name="feature_img_3" data-label="Icon :" data-placeholder="Sélectionner un icon" data-value="<?= ThemeModel::getInstance()->fetchConfigValue("feature_img_3") ?>"></div>
                <div class="form-group">
                    <label>Titre :</label>
                ...
                <div class="form-group">
                    <label>Description :</label>
                    <input class="input text-center" type="text" id="feature_description_3"
        ...
        <div class="card-in-card mt-4">
            <div class="card-body">
                <label class="toggle">
                    <h6 class="toggle-label">Trailer :</h6>
                    <input type="checkbox" class="toggle-input" name="trailer_section_active" <?= ThemeModel::getInstance()->fetchConfigValue('trailer_section_active') ? 'checked' : '' ?>>
                    <div class="toggle-slider"></div>
                </label>
                <label>Titre de la section :</label>
                <input type="text" class="input" name="trailer_title"
                       value="<?= ThemeModel::getInstance()->fetchConfigValue('trailer_title') ?>" required>
                <div class="form-group">
                    <label>Texte :</label>
                    <input class="input" type="text" id="trailer_text" name="trailer_text"
                           value="<?= ThemeModel::getInstance()->fetchConfigValue('trailer_text') ?>">
                </div>
                <div class="grid-3">
                    <div class="form-group">
                        <label>Texte du bouton :</label>
                        <input class="input" type="text" id="trailer_button_text" name="trailer_button_text"
                               value="<?= ThemeModel::getInstance()->fetchConfigValue('trailer_button_text') ?>">
                    </div>
                    <div class="form-group">
                        <label>Lien du bouton :</label>
                        <input class="input" type="text" id="trailer_button_link" name="trailer_button_link"
                               value="<?= ThemeModel::getInstance()->fetchConfigValue('trailer_button_link') ?>">
                    </div>
                    <div class="form-group">
                        <label>Code du lien youtube :</label>
                        <input class="input" type="text" id="trailer_youtube_link" name="trailer_youtube_link"
        ...
        <?php if (PackageController::isInstalled("News")): ?>
            ...
            <div class="form-group">
                <label>Texte du bouton :</label>
                <input class="input" type="text" id="news_button" name="news_button"
