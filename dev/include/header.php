<nav class="px-2 py-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class=" flex flex-wrap  items-center mx-auto">
        <a href="#" class="flex items-center">
            <img src="https://dev.voyza.fr/public/uploads/Rainfall/logo.png" class="mr-3 w-16" alt="Flowbite Logo">
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Votre site</span>
        </a>
        <div class="flex ml-auto lg:order-2">
            <a href="login" class="hidden lg:inline lg:bg-white bg-blue-700 lg:hover:bg-gray-200 hover:bg-blue-800 text-white lg:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 lg:px-5 lg:py-2.5 mr-1 lg:mr-2 h-fit">Connexion</a>
            <a href="register" class="hidden lg:inline text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-4 py-2 lg:px-5 lg:py-2.5 mr-1 lg:mr-2 h-fit">S'inscrire</a>

            <ul class="flex flex-col p-4">
                <li>
                    <button id="dropdownNavbarLinkProfil" data-dropdown-toggle="dropdownNavbarProfil" class="flex justify-between items-center py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 lg:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 lg:dark:hover:bg-transparent"><i class="mr-2 fa-solid fa-user"></i> Zomb</button>
                    <!-- Dropdown menu -->
            ...
            <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 text-lg p-2.5">
        ...
        <div class="hidden w-full lg:block lg:w-auto lg:ml-6" id="navbar-multi-level">
            <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 lg:flex-row lg:space-x-8 lg:mt-0 lg:text-sm lg:font-medium lg:border-0 lg:bg-white dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700">
                <li>
                ...
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent">Services</a>
                </li>
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent">Pricing</a>
                </li>
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent">Contact</a>
                </li>
            </ul>
        </div>
    </div>
